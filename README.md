...
## Computer Requirements and Necessary Software

This course uses Python notebooks, not R.

### Required

- A laptop/desktop with stable internet access and a modern browser (Chrome, Edge, Firefox, or Safari)
- [GitHub account](https://github.com)
- [Google account](https://accounts.google.com) for [Google Colab](https://colab.research.google.com)

### Required Course Platforms

- [Google Colab](https://colab.research.google.com) (default coding environment)
- [GitHub](https://github.com) (course repository access and assignment workflow)
- [Sogang LMS](https://eclass.sogang.ac.kr/) (official grades and formal announcements)

### Optional but Recommended

- [DataCamp account](https://app.datacamp.com/) for beginner refreshers
- [Slack desktop app](https://slack.com/downloads/) or [Slack mobile app](https://slack.com/downloads/in-app) for course discussion
- [Binder](https://mybinder.org/v2/gh/GSIS-DS/data-science-ai-global-decision-making/main) for temporary public exploration

### Important Environment Note

- Graded work should be completed in the Colab/GitHub/LMS workflow.
- Binder is temporary and should be used for exploration, not as your primary graded-work environment.

### Step-by-Step Setup Guides

- [GitHub account setup](getting-started/github-basics.md)
- [DataCamp account setup](getting-started/datacamp-readiness.md)
- [Slack setup and account creation](getting-started/slack-setup.md)
